...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AboutlibrariesLibraryAccessors laccForAboutlibrariesLibraryAccessors = new AboutlibrariesLibraryAccessors(owner);
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for mediapipe (com.google.mediapipe:tasks-vision)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMediapipe() {
            return create("mediapipe");
    }

    /**
     * Returns the group of libraries at aboutlibraries
     */
    public AboutlibrariesLibraryAccessors getAboutlibraries() {
        return laccForAboutlibrariesLibraryAccessors;
    }
    ...
    public static class AboutlibrariesLibraryAccessors extends SubDependencyFactory {
        private final AboutlibrariesComposeLibraryAccessors laccForAboutlibrariesComposeLibraryAccessors = new AboutlibrariesComposeLibraryAccessors(owner);

        public AboutlibrariesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for core (com.mikepenz:aboutlibraries-core)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
                return create("aboutlibraries.core");
        }

        /**
         * Returns the group of libraries at aboutlibraries.compose
         */
        public AboutlibrariesComposeLibraryAccessors getCompose() {
            return laccForAboutlibrariesComposeLibraryAccessors;
        }

    }

    public static class AboutlibrariesComposeLibraryAccessors extends SubDependencyFactory {

        public AboutlibrariesComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for core (com.mikepenz:aboutlibraries-compose-core)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCore() {
                return create("aboutlibraries.compose.core");
        }

            /**
             * Creates a dependency provider for m2 (com.mikepenz:aboutlibraries-compose)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getM2() {
                return create("aboutlibraries.compose.m2");
        }

            /**
             * Creates a dependency provider for m3 (com.mikepenz:aboutlibraries-compose-m3)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getM3() {
                return create("aboutlibraries.compose.m3");
        }
    ...
    public static class AndroidxCameraLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxCameraLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for camera (androidx.camera:camera-camera2)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
                return create("androidx.camera");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final MediapipeVersionAccessors vaccForMediapipeVersionAccessors = new MediapipeVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: aboutLibraries (12.2.3)
            ...
            /**
             * Returns the version associated to this alias: coreKtx (1.14.0-alpha01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: lifecycleService (2.8.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.camerax
         */
        ...
        /**
         * Returns the group of versions at versions.mediapipe
         */
        public MediapipeVersionAccessors getMediapipe() {
            return vaccForMediapipeVersionAccessors;
        }
    ...
    public static class CameraxVersionAccessors extends VersionFactory  {
        ...
        public CameraxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: camerax.version (1.2.0-alpha02)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("camerax.version"); }
    ...
    public static class LottieVersionAccessors extends VersionFactory  {
        ...
        public LottieVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lottie.compose (6.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class MediapipeVersionAccessors extends VersionFactory  {

        public MediapipeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: mediapipe.version (0.10.9)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("mediapipe.version"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for aboutLibraries to the plugin id 'com.mikepenz.aboutlibraries.plugin'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getAboutLibraries() { return createPlugin("aboutLibraries"); }
